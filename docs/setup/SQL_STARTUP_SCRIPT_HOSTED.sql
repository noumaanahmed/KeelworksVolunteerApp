...
--
-- WARNING:
--   This script wipes the KeelWorks tables in the currently selected
--   hosted database/schema and recreates the clean MVP schema from scratch.
--
-- What this includes:
...
-- For hosted MySQL/Railway: select the hosted database/schema as the default schema before running this script.
-- Do not create a separate volunteer_management database unless your host explicitly supports it.

-- USE your_hosted_database_name; -- Optional: uncomment and replace if needed

...
`Volunteer-Application-Backend-Feature-FormSubmit/docs/sql/create_users_table.sql`
...
Then open:
`Volunteer-Application-Backend-Feature-FormSubmit/src/.env`
...
```bash
cd Volunteer-Application-Backend-Feature-FormSubmit
npm install
cd src
